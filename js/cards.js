...
const cardData = [
    ...
    {
        img: "https://images.unsplash.com/photo-1465101178521-c1a9136a3c5a?auto=format&fit=crop&w=800&q=80",
        duration: "100’",
    ...
    {
        img: "https://images.unsplash.com/photo-1514361892635-cebb9a1b2d8e?auto=format&fit=crop&w=600&q=80",
        duration: "60’",
    ...
    el.innerHTML = `
      ...
      <div class="card__info">
        <div class="card__meta">
          ...
          <span class="card__icon card__icon--clock" title="Durata"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" stroke="#888" stroke-width="1.5" fill="none"/><path d="M12 7v5l3 3" stroke="#888" stroke-width="1.5" fill="none"/></svg></span><span class="card__duration">${card.duration}</span>
        </div>
        ...
        <div class="card__price-row">
          <div>
            <span class="card__price-label">PREZZO</span>
            <span class="card__price"><b>&euro;${card.price} a persona</b></span>
          </div>
          <span class="card__vat">${card.vat}</span>
        </div>
        <button class="card__btn">Dettagli <span class="card__btn-arrow" style="display:inline-flex;vertical-align:middle;"><svg xmlns="http://www.w3.org/2000/svg" width="1.7em" height="1.7em" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/></svg></span></button>
      </div>
    `;
    grid.appendChild(el);
  });
